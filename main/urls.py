...
from main.views import show_main, create_product, show_product, register, login_user, logout_user, edit_product, delete_product, show_xml, show_json, show_xml_by_id, show_json_by_id
